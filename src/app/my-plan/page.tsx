...
const MyPlanPage = () => {
  ...
  return (
    <main className="flex-1 bg-[var(--fitlog-bg)]">
      <section className="border-b border-[var(--fitlog-border)] px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div className="mx-auto max-w-[1400px]">
          ...
          {/* Tabs */}
          <div className="mt-10 flex gap-2 border-b border-[var(--fitlog-border)]">
            <button
              type="button"
            ...
            <div className="mt-10 rounded-2xl border border-dashed border-[var(--fitlog-border)] bg-[var(--fitlog-card)] px-6 py-16 text-center">
              ...
              <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-[var(--fitlog-muted)]">
                {activeTab === "plan"
                  ...
                  : "Brows the library and add a lift to get today moving."}
              </p>
